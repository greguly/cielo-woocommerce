...
class WC_Cielo_Version {
     ...
     */
    public static function getVersions( $field ) {
     ...
     * Get full version list.
     */
    public static function getVersion( $field, $version = "" ) {

        WC_Cielo_Version::$options = WC_Cielo_Version::getDataVersion()['versions'][$version][$field];
