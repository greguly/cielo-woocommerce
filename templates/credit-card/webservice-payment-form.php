...
<fieldset id="cielo-credit-payment-form" class="cielo-payment-form">
	<p class="form-row form-row-first">
		...
		<input id="cielo-card-number" name="cielo_credit_number" class="input-text wc-credit-card-form-card-number" type="tel" maxlength="20" autocomplete="off" placeholder="&bull;&bull;&bull;&bull; &bull;&bull;&bull;&bull; &bull;&bull;&bull;&bull; &bull;&bull;&bull;&bull;" style="font-size: 1.5em; padding: 8px;" />
	</p>
